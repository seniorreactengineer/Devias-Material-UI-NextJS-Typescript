...
import { AccountSettingsShops } from "@components/dashboard/account/account-shops-settings";
import { AccountDocumentSettings } from "@components/dashboard/account/account-document-settings";
    ...
    <>
      ...
      >
        <Container maxWidth="md">
          ...
          {currentTab === "shops" && <AccountSettingsShops />}
          {currentTab === "document" && <AccountDocumentSettings />}
        </Container>
      </Box>
    </>
  );
